...
// This file contains code adapted from the OpenTelemetry Go project:
// https://github.com/open-telemetry/opentelemetry-go/blob/v1.40.0/exporters/otlp/otlplog/otlploggrpc/internal/transform/log.go
